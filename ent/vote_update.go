...
func (_u *VoteUpdate) SetUserID(id string) *VoteUpdate {
...
func (_u *VoteUpdate) SetPollOptionID(id int) *VoteUpdate {
	_u.mutation.SetPollOptionID(id)
	return _u
}
...
// SetUserID sets the "user" edge to the User entity by ID.
func (_u *VoteUpdateOne) SetUserID(id string) *VoteUpdateOne {
	_u.mutation.SetUserID(id)
	return _u
}
...
// SetPollOptionID sets the "poll_option" edge to the PollOption entity by ID.
func (_u *VoteUpdateOne) SetPollOptionID(id int) *VoteUpdateOne {
	_u.mutation.SetPollOptionID(id)
	return _u
}
