...
func (_c *PollOptionCreate) SetVotesCount(v int) *PollOptionCreate {
	_c.mutation.SetVotesCount(v)
	return _c
}

// SetNillableVotesCount sets the "votes_count" field if the given value is not nil.
func (_c *PollOptionCreate) SetNillableVotesCount(v *int) *PollOptionCreate {
	if v != nil {
		_c.SetVotesCount(*v)
	}
	return _c
...
func (_c *PollOptionCreate) SetNillablePollID(id *int) *PollOptionCreate {
	if id != nil {
		_c = _c.SetPollID(*id)
	}
	return _c
...
func (_c *PollOptionCreate) defaults() {
	if _, ok := _c.mutation.VotesCount(); !ok {
		v := polloption.DefaultVotesCount
		_c.mutation.SetVotesCount(v)
	}
}
...
func (_c *PollOptionCreate) check() error {
	...
	if _, ok := _c.mutation.VotesCount(); !ok {
		return &ValidationError{Name: "votes_count", err: errors.New(`ent: missing required field "PollOption.votes_count"`)}
	}
	return nil
}
