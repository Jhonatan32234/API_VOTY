...
func IsOpen(v bool) predicate.Poll {
	return predicate.Poll(sql.FieldEQ(FieldIsOpen, v))
}
...
func IsOpenEQ(v bool) predicate.Poll {
	return predicate.Poll(sql.FieldEQ(FieldIsOpen, v))
}

// IsOpenNEQ applies the NEQ predicate on the "is_open" field.
func IsOpenNEQ(v bool) predicate.Poll {
	return predicate.Poll(sql.FieldNEQ(FieldIsOpen, v))
}
