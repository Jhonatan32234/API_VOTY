...
func (_u *PollOptionUpdate) SetVotesCount(v int) *PollOptionUpdate {
...
func (_u *PollOptionUpdate) SetNillableVotesCount(v *int) *PollOptionUpdate {
	if v != nil {
		_u.SetVotesCount(*v)
	}
	return _u
...
func (_u *PollOptionUpdate) AddVotesCount(v int) *PollOptionUpdate {
...
func (_u *PollOptionUpdate) SetNillablePollID(id *int) *PollOptionUpdate {
	if id != nil {
		_u = _u.SetPollID(*id)
	}
	return _u
...
// SetVotesCount sets the "votes_count" field.
func (_u *PollOptionUpdateOne) SetVotesCount(v int) *PollOptionUpdateOne {
	_u.mutation.ResetVotesCount()
	_u.mutation.SetVotesCount(v)
	return _u
}
...
// SetNillableVotesCount sets the "votes_count" field if the given value is not nil.
func (_u *PollOptionUpdateOne) SetNillableVotesCount(v *int) *PollOptionUpdateOne {
	if v != nil {
		_u.SetVotesCount(*v)
	}
	return _u
...
// SetNillablePollID sets the "poll" edge to the Poll entity by ID if the given value is not nil.
func (_u *PollOptionUpdateOne) SetNillablePollID(id *int) *PollOptionUpdateOne {
	if id != nil {
		_u = _u.SetPollID(*id)
	}
	return _u
