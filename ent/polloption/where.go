...
func VotesCount(v int) predicate.PollOption {
...
func VotesCountEQ(v int) predicate.PollOption {
	return predicate.PollOption(sql.FieldEQ(FieldVotesCount, v))
}

// VotesCountNEQ applies the NEQ predicate on the "votes_count" field.
func VotesCountNEQ(v int) predicate.PollOption {
	return predicate.PollOption(sql.FieldNEQ(FieldVotesCount, v))
}

// VotesCountIn applies the In predicate on the "votes_count" field.
func VotesCountIn(vs ...int) predicate.PollOption {
	return predicate.PollOption(sql.FieldIn(FieldVotesCount, vs...))
}

// VotesCountNotIn applies the NotIn predicate on the "votes_count" field.
func VotesCountNotIn(vs ...int) predicate.PollOption {
	return predicate.PollOption(sql.FieldNotIn(FieldVotesCount, vs...))
}

// VotesCountGT applies the GT predicate on the "votes_count" field.
func VotesCountGT(v int) predicate.PollOption {
	return predicate.PollOption(sql.FieldGT(FieldVotesCount, v))
}

// VotesCountGTE applies the GTE predicate on the "votes_count" field.
func VotesCountGTE(v int) predicate.PollOption {
	return predicate.PollOption(sql.FieldGTE(FieldVotesCount, v))
}

// VotesCountLT applies the LT predicate on the "votes_count" field.
func VotesCountLT(v int) predicate.PollOption {
	return predicate.PollOption(sql.FieldLT(FieldVotesCount, v))
}
